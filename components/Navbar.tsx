...
export const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 py-4 md:px-12 md:py-4 w-full bg-black/80 backdrop-blur-xl border-b border-white/5">
      ...
      <button className="px-4 py-2 md:px-5 md:py-2.5 bg-white/10 border border-white/10 hover:border-white/30 hover:bg-white/20 rounded-full text-xs md:text-sm font-semibold transition-all backdrop-blur-sm">
        Get started
      </button>
    </nav>
  );
